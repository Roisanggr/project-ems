// EMS Frontend Application - TypeScript Version
// ES6 Module-based application with type safety

import type { ChartConfig, SidebarElement, QuantitySpinner } from '../types/index.js';
...
document.addEventListener('DOMContentLoaded', (): void => {
    console.log('🚀 EMS Frontend Initialized (TypeScript)');
...
export { initCharts, createChart, initSidebar, initQuantitySpinner };